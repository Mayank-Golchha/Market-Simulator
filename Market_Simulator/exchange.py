...
# #
# #         self.buy_prices = [] # will store only keys of buy data
# #         self.sell_prices = [] # will store keys of sell data
# #
...
#
#         # self.initialize_traders() # puts traders in market
#
#     def initialize_traders(self,indicators,level_2_data):
#         TraderEngine.initialize_random_traders(self.traders) # random traders
#         TraderEngine.initialize_level1_traders(self.traders) # level1 traders
#         TraderEngine.initialize_level2_traders(self.traders,indicators) # level1 traders
